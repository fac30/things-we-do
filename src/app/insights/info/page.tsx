      ...
      <div className="bg-twd-background text-white min-h-screen px-10 py-6">
        ...
        <div className="mt-10">
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              This feature isn’t just about collecting data—it’s about helping
              you see the bigger picture. It empowers you to:
            </p>
            <ul className="list-disc list-inside space-y-4 text-gray-400">
              <li>Understand patterns in your behavior and emotions.</li>
              <li>Discover what tools and approaches work best for you.</li>
              <li>
